...
Before generating the report, load and use the [Build Health Report skill](../skills/build-health-report/SKILL.md) for the HTML report structure, metric presentation, and risk-assessment guidance. The Release Radar requirements in this file take precedence if they conflict.
